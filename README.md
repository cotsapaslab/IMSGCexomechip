...
+ In step 1, you must first modify the meta file. An example meta file used in our analysis is in IMSGCexomechip/src/basic_qc/meta. Structure of meta file used in this analysis is described in ~/IMSGCexomechip/basic_qc/README. You must provide path to your input zcall and gencall PLINK files and output directory. In addition, copy controls_bu.zip and controls.zip from our DropBox [https://www.dropbox.com/sh/jkkbz4p3ltilrm9/AAD5SsmJiKrfZGOCVvMeGw71a?dl=0] and expand them to /IMSGCexomechip/src/basic_qc/controls/ directory before running the pipeline.
